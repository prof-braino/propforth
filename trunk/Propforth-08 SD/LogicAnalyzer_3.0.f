\ LogicAnalyzer.f 20101218-1032 split line 135
...
\ the assembler code which samples every 40 or more cycles to hub memory, 
\ and the routine which measures the cycle time of the trigger 
lockdict
variable _def_sam2 
0169 l, 014F l,
0 l, 0 l, 0 l, 
F03EA14F l, F03EA34F l, A0BE13F2 l, A0BE15F1 l, 80BE155F l, 083E135D l, 
F8BE155F l, A0BE13F2 l, 80FEBA04 l, E4FEBD57 l, 5C7C0075 l,
0 l, 0 l, 0 l, 
5CFDCEE0 l, F03EA14F l, F03EA34F l, A0BE13F1 l, F03EA14F l, F03EA34F l, 
A0BE11F1 l, 84BE1109 l, 5C7C0075 l,
freedict
...
: _ds 14F coghere W! 0 cog, 0 cog, 0 cog, cog, cog, 
9A 0 do A0BC01F2 coghere W@ 9 lshift or cog, loop 5C7C0075 cog, ;

\ loads the assembler which samples every 40+ clock cylces, 
\ and teh assembler which measure trigger frequency
...
\ this variable value is the first of 4 sequential cogs used to sample every clock cycle, 
\ default to this cog 0
